...
class TemplateMinerConfig:
    def __init__(self) -> None:
        ...
        self.drain_max_clusters_per_token_count: Optional[int] = None
        self.drain_shard_workers = os.cpu_count()
    ...
    def load(self, config_filename: str) -> None:
        ...
        self.drain_max_clusters_per_token_count = parser.getint(
            section_drain,
            'max_clusters_per_token_count',
            fallback=self.drain_max_clusters_per_token_count
        )
        print(f"drain_max_clusters_per_token_count: {self.drain_max_clusters_per_token_count}")
        self.drain_shard_workers = parser.getint(section_drain, 'shard_workers',
                                                 fallback=self.drain_shard_workers)
        print(f"drain_shard_workers: {self.drain_shard_workers}")
